...
<html lang="fr">
    <head>
        ...
        <![endif]-->
        <link rel="apple-touch-icon-precomposed" sizes="144x144" href="http://breithbarbot.com/apple-touch-icon-144x144-precomposed.png">
        <link rel="apple-touch-icon-precomposed" sizes="114x114" href="http://breithbarbot.com/apple-touch-icon-114x114-precomposed.png">
        <link rel="apple-touch-icon-precomposed" sizes="72x72" href="http://breithbarbot.com/apple-touch-icon-72x72-precomposed.png">
    ...
    <body>
        <div class="container">
            ...
            <br>
            <p>This is a blue <code>&lt;div id="exclude"&gt;s&lt;/div&gt;</code> content available at the right click.</p>
            <div id="exclude"></div>
        </div>
